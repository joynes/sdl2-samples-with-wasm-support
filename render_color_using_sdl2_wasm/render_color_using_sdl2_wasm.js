...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 66048,
    DYNAMIC_BASE = 5308928,
    DYNAMICTOP_PTR = 65888;
...
var wasmBinaryFile = 'render_color_using_sdl2_wasm.wasm';
...
var ASM_CONSTS = {
  1514: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
